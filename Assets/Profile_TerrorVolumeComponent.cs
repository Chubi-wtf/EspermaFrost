...
[VolumeComponentMenu("Post-processing Custom/Profile_Terror")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(Profile_TerrorRendererFeature))]
...
public sealed class Profile_TerrorVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Set the name of the volume component in the list in the Volume Profile.
    public Profile_TerrorVolumeComponent()
    {
        displayName = "Profile_Terror";
    }
