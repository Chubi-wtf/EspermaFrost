...
public sealed class Profile_TerrorRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        Profile_TerrorVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<Profile_TerrorVolumeComponent>();
